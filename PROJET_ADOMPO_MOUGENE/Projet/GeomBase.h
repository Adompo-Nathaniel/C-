...
class Color {
	public:
		enum colortype : uint8_t {
			...
			grey, cyan, blue, brown, black, salmon, darkolivegreen, beige, 
			goldenrod, silver, slategrey, saddlebrown, lime, fuchsia, steelblue, none
		};
	private:
		static const std::size_t nColor = 24;
...
namespace Geom2D {
	...
	public:
		...
		virtual void Resize(float s) = 0;
		virtual int getType() = 0;
		virtual void setColor(Color couleur) = 0;
	};
